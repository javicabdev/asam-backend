...
func (r *mutationResolver) ConfirmPayment(ctx context.Context, id string, paymentMethod string, paymentDate *time.Time, notes *string, amount *float64) (*models.Payment, error) {
	...
	payment, err := r.paymentService.ConfirmPayment(ctx, paymentID, paymentMethod, paymentDate, notes, amount)
	if err != nil {
		return nil, err
	}
...
type (
	cashFlowResolver      struct{ *Resolver }
	familiarResolver      struct{ *Resolver }
	familyResolver        struct{ *Resolver }
	memberResolver        struct{ *Resolver }
	membershipFeeResolver struct{ *Resolver }
	mutationResolver      struct{ *Resolver }
	paymentResolver       struct{ *Resolver }
	queryResolver         struct{ *Resolver }
	telephoneResolver     struct{ *Resolver }
